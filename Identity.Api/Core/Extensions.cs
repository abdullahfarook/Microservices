namespace Identity.Api.Core
{
    public static partial class Extensions
    {
        ...
        public static string Facebook { get; set; } = "framework";
        public static string LinkedIn { get; set; } = "framework";
        public static string Twitter { get; set; } = "framework";
    ...
    //        //create salt
    //        byte[] salt;
    //        using (var rnCrypt = new RNGCryptoServiceProvider())
    //        {
    //            rnCrypt.GetBytes(salt = new byte[SaltSize]);
    //        }
    //        //create hash
